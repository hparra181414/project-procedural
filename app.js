...
// VIEW STATE
// ============================================================
// Which top-level screen is showing. Session state (active or not) still
// decides start-vs-active; this just adds a third screen on top of that.
...
function renderHistoryList() {
  const sessions = [...getSessions()].reverse(); // newest first
...
function renderApp() {
  ...
  // History takes priority as an overlay-style screen you explicitly navigate to.
...
document.getElementById('back-from-history-btn').addEventListener('click', hideHistory);
